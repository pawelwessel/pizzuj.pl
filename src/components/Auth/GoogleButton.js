  ...
  return (
    <div className="google-button-container">
      <button
        ...
        type="button"
        className={`rounded-lg w-[279px] md:w-full text-lg block bg-white hover:bg-gray-100 focus:bg-gray-100 text-black font-gotham font-semibold px-4 py-3 border border-gray-300`}
      >
