...
export default function ImageGallery({ images, isOpen, onClose, initialIndex = 0 }) {
  ...
  const imageSrc = currentImage.photo_reference
    ? `https://maps.googleapis.com/maps/api/place/photo?maxwidth=1200&photo_reference=${currentImage.photo_reference}&key=${process.env.NEXT_PUBLIC_FIREBASE_MAP_KEY}`
    : "/assets/pizza.png";
