...
export default function PopupHeader({ place, onClose }) {
  ...
  return (
    <div className="relative h-72 lg:h-80 overflow-hidden">
      ...
      {place.rating && (
        <div
          className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm rounded-2xl px-4 py-2 flex items-center gap-2 shadow-lg"
          aria-label={`Ocena: ${place.rating} na 5 gwiazdek, ${place.user_ratings_total} ocen`}
        >
