      ...
      <div className="relative z-10 mx-auto w-[90%] lg:w-4/5 xl:w-3/4 2xl:w-2/3">
        <div className="bg-black/80 p-8 lg:p-12 xl:p-16 rounded-2xl text-center">
          <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6">
            Dołącz do społeczności <span className="text-[#ffa920]">Pizzuj.pl</span>
          </h2>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
              ...
              <p className="text-white/80 text-sm">Znajdź najlepsze pizzerie w swojej okolicy</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
              <div className="text-3xl mb-3">⭐</div>
              <h3 className="text-white font-bold text-lg mb-2">Oceniaj</h3>
              <p className="text-white/80 text-sm">Dziel się swoimi opiniami i doświadczeniami</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
              <div className="text-3xl mb-3">👥</div>
              <h3 className="text-white font-bold text-lg mb-2">Społeczność</h3>
              <p className="text-white/80 text-sm">Połącz się z innymi miłośnikami pizzy</p>
            </div>
          </div>
        </div>
      </div>
