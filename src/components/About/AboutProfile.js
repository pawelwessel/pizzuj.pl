          ...
          <div className="order-2 lg:order-1">
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 lg:p-10 rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Jestem programistą z kilkuletnim doświadczeniem, ale moją prawdziwą pasją jest również pizza.
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Kilkuletnie doświadczenie w technologii</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800">Pasjonat pizzy</h3>
                    <p className="text-gray-600 text-sm">Specjalista ds. mięs i ciasta</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-[#ffa920] rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800">Tutti Santi, Grudziądz</h3>
                    <p className="text-gray-600 text-sm">Tam pogłębiłem zamiłowanie do sztuki pizzy</p>
                  </div>
                </div>
              </div>
            </div>
