...
export default function FoodCostCalculator() {
  ...
  const [ingredients, setIngredients] = useState([
    { id: 1, name: "Ciasto", quantity: 250, unit: "g", costPer100g: 0.80 },
    { id: 2, name: "Sos pomidorowy", quantity: 80, unit: "g", costPer100g: 2.50 },
    { id: 3, name: "Mozzarella", quantity: 120, unit: "g", costPer100g: 18.00 },
    { id: 4, name: "Basilico", quantity: 10, unit: "g", costPer100g: 25.00 },
  ]);
  ...
  const updateIngredient = (id, field, value) => {
    setIngredients(ingredients.map(ingredient =>
      ingredient.id === id
        ? { ...ingredient, [field]: field === 'quantity' || field === 'costPer100g' ? parseFloat(value) || 0 : value }
        : ingredient
    ));
  };
            ...
            <div>
              ...
              <div className="space-y-4">
                {ingredients.map((ingredient) => (
                  <div key={ingredient.id} className="grid grid-cols-12 gap-3 items-center p-4 bg-gray-50/70 rounded-xl border border-gray-200/50">
                    ...
                    <div className="col-span-10 md:col-span-3">
                      <input
                        ...
                        onChange={(e) => updateIngredient(ingredient.id, 'costPer100g', e.target.value)}
                        className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-800 bg-white/70 backdrop-blur-sm focus:ring-2 focus:ring-primary-400 focus:border-transparent transition-all"
              ...
              <div className="border-t border-gray-200 pt-4">
                <div className="text-sm text-gray-600 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{costPerServing.toFixed(2)} zł</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Marża:</span>
