...
import { FaUser, FaPizzaSlice, FaChartBar, FaCog, FaCheck, FaArrowRight, FaArrowLeft } from 'react-icons/fa';
...
const OnboardingWizard = ({ 
  ...
  const steps = [
    {
      ...
      description: 'Pozwól nam pokazać Ci, jak w pełni wykorzystać swój panel użytkownika.',
      icon: FaUser,
      content: (
        <motion.div
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-800">Witaj, {userData?.name || 'Użytkowniku'}!</h2>
          <p className="text-gray-600 max-w-md mx-auto">
            Twój panel użytkownika to centrum zarządzania Twoimi pizzeriami i promocją. 
            Przejdźmy przez najważniejsze funkcje krok po kroku.
          </p>
        </motion.div>
      )
    },
      ...
      content: (
        ...
        >
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Co możesz zrobić w sekcji Profil:</h3>
    ...
    },
    {
      ...
      content: (
        ...
        >
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Funkcje zarządzania pizzeriami:</h3>
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-center">
                <FaCheck className="text-green-500 mr-3" />
    ...
    },
    {
      ...
      content: (
        ...
        >
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Dostępne analizy:</h3>
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-center">
                <FaCheck className="text-green-500 mr-3" />
    ...
    {
      id: 'tour',
      title: 'Wycieczka po Panelu',
      description: 'Pozwól nam pokazać Ci wszystko w praktyce.',
      icon: FaCog,
      content: (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-gray-800">Interaktywna Wycieczka</h3>
          <p className="text-gray-600 max-w-md mx-auto">
            Rozpocznij interaktywną wycieczkę po panelu, która pokaże Ci wszystkie funkcje w praktyce.
          </p>
          <motion.button
  ...
  const handleComplete = () => {
    ...
    toast.success('Onboarding zakończony! Teraz możesz w pełni korzystać ze swojego panelu.');
  };
              ...
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center mr-4">
                    {React.createElement(steps[currentStep].icon, { className: "text-white text-xl" })}
                  </div>  
    <div>
