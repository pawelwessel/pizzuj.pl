...
import { FaPlay, FaPause, FaRedo, FaTimes, FaChevronRight, FaChevronLeft, FaCheck } from 'react-icons/fa';
...
const CustomTour = ({ 
  ...
  const steps = useMemo(() => [
    {
      ...
      content: (
        ...
        >
          <h3 className="text-xl font-bold text-orange-600 mb-2">👋 Witaj w Pizzuj!</h3>
          <p className="text-gray-700">
            To jest Twój panel użytkownika. Pozwól mi pokazać Ci najważniejsze funkcje.
          </p>
        </motion.div>
      ),
      placement: 'bottom',
    },
    {
      ...
      content: (
        <motion.div
          ...
          className="text-center"
        >
          <h3 className="text-xl font-bold text-orange-600 mb-2">📋 Nawigacja</h3>
          <p className="text-gray-700">
            Tutaj możesz przełączać się między różnymi sekcjami: Profil i Moje Pizzerie.
          </p>
        </motion.div>
      ),
      placement: 'bottom',
    },
    {
      ...
      content: (
        <motion.div
          ...
          className="text-center"
        >
          <h3 className="text-xl font-bold text-orange-600 mb-2">👤 Twój Profil</h3>
          <p className="text-gray-700">
            Tutaj możesz edytować swoje dane osobowe i zarządzać ustawieniami konta.
          </p>
        </motion.div>
      ),
      placement: 'right',
    },
    {
      ...
      content: (
        <motion.div
          ...
          className="text-center"
        >
          <h3 className="text-xl font-bold text-orange-600 mb-2">🍕 Moje Pizzerie</h3>
          <p className="text-gray-700">
            Dodawaj i zarządzaj swoimi pizzeriami. To miejsce, gdzie możesz promować swoje lokale.
          </p>
        </motion.div>
      ),
      placement: 'left',
    },
    {
      ...
      content: (
        <motion.div
          ...
          className="text-center"
        >
          <h3 className="text-xl font-bold text-orange-600 mb-2">🎉 Gotowe!</h3>
          <p className="text-gray-700">
            Teraz znasz podstawy swojego panelu. Możesz wrócić do tej wycieczki w dowolnym momencie.
          </p>
        </motion.div>
      ),
      placement: 'top',
  ...
  useEffect(() => {
    ...
    if (target) {
      ...
      const position = calculateTooltipPosition(target, currentStepData.placement);
  ...
  const handleSkip = () => {
    if (onSkip) onSkip();
    toast.info('Wycieczka została pominięta. Możesz ją wznowić w dowolnym momencie.');
  };
