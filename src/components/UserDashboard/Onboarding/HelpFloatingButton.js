...
const HelpFloatingButton = ({ onStartTour, onStartOnboarding, isOnboardingCompleted }) => {
          ...
          >
            ...
            <div className="space-y-3">
              <motion.button
                ...
                className="w-full flex items-center justify-between p-3 bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg hover:from-orange-100 hover:to-orange-200 transition-all duration-200"
              >
                <span className="text-gray-700 font-medium">Interaktywna Wycieczka</span>
              ...
              {!isOnboardingCompleted && (
                ...
                >
                  <span className="text-gray-700 font-medium">Pełny Onboarding</span>
                  <FaPlay className="text-blue-600" />
                </motion.button>
              )}

              <div className="border-t border-gray-200 pt-3">
                <h4 className="text-sm font-medium text-gray-600 mb-2">Szybkie podpowiedzi:</h4>
