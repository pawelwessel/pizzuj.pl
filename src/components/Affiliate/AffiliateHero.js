...
import { FaHandshake, FaMoneyBillWave, FaChartLine, FaUsers } from "react-icons/fa";
...
export default function AffiliateHero() {
  const highlights = [
    ...
    { icon: FaChartLine, text: "Transparentne rozliczenia", color: "text-blue-500" },
        ...
        <div className="glass bg-black/50 backdrop-blur-xl p-6 sm:p-8 lg:p-12 rounded-2xl lg:rounded-3xl border border-white/30 shadow-large">
          ...
          <div className="text-center mb-8 lg:mb-12">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h1 className="font-cocosharp-bold-italic !text-white text-3xl sm:text-4xl lg:text-5xl xl:text-6xl leading-tight drop-shadow-lg">
                Program <span className="text-[#ffa920]">Partnerski</span>
              </h1>
              <FaHandshake className="text-[#ffa920] text-3xl lg:text-4xl animate-bounce-gentle" style={{ animationDelay: "0.5s" }} />
            </div>
            
            <p className={`!text-white/90 text-lg sm:text-xl lg:text-2xl max-w-4xl mx-auto leading-relaxed mb-8 ${ptSans.className}`}>
              Zarabiaj polecając najlepsze pizzerie w Polsce! 
              <span className="text-[#ffa920] font-semibold"> Wysokie prowizje</span>, transparentne rozliczenia i pełne wsparcie.
            </p>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-10">
              {highlights.map((highlight, index) => (
                ...
                >
                  <highlight.icon className={`${highlight.color} text-2xl lg:text-3xl mx-auto mb-3 group-hover:scale-110 transition-transform duration-300`} />
