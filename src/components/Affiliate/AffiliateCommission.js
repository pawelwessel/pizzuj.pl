  ...
  const tiers = [
    {
      ...
      features: ["Podstawowe linki partnerskie", "Panel statystyk", "Wypłaty co 2 tygodnie"]
    },
    {
      icon: FaStar,
      name: "Silver",
      ...
      features: ["Wyższe prowizje", "Dedykowane kody promocyjne", "Priorytetowe wsparcie"]
    },
    {
      icon: FaCrown,
      name: "Gold",
      ...
      features: ["Najwyższe prowizje", "Ekskluzywne promocje", "Account manager", "Bonusy miesięczne"],
      popular: true
    },
    {
      icon: FaRocket,
      ...
      features: ["Indywidualne ustalenia", "Specjalne kampanie", "Revenue share", "Priorytetowe nowe funkcje"]
    }
  ];
      ...
      <div className="relative z-10 mx-auto w-[95%] sm:w-[90%] lg:w-[80%] max-w-6xl">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className={`text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed ${ptSans.className}`}>
            Im więcej sprzedajesz, tym wyższe prowizje otrzymujesz. Nasze poziomy partnerskie nagradzają najaktywniejszych.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-12">
          {tiers.map((tier, index) => (
            <div
              key={index}
              className={`group relative p-6 lg:p-8 card-hover ${tier.popular ? 'transform scale-105' : ''}`}
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              {/* Popular badge */}
              {tier.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-[#ffa920] text-white px-4 py-1 rounded-full text-sm font-semibold">
                  Najpopularniejszy
                </div>
              )}

              {/* Glass background */}
              <div className={`absolute inset-0 glass rounded-2xl bg-white/60 backdrop-blur-xl border ${tier.borderColor} shadow-large group-hover:shadow-golden-lg transition-all duration-300 group-hover:scale-105 ${tier.popular ? 'border-[#ffa920] shadow-golden' : ''}`}></div>
              
              {/* Content */}
              <div className="relative z-10 text-center">
                {/* Icon container */}
                <div className={`w-16 h-16 ${tier.bgColor} rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="mb-4">
                  ...
                  <p className={`text-gray-600 text-sm mt-1 ${ptSans.className}`}>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <p className={`text-gray-700 ${ptSans.className}`}>
                  <span className="font-semibold">Wypłaty co 2 tygodnie</span> - regularne i przewidywalne przychody
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 rounded-full bg-[#ffa920] flex items-center justify-center text-white font-bold text-xs flex-shrink-0 mt-1">
                ...
                <p className={`text-gray-700 ${ptSans.className}`}>
                  <span className="font-semibold">Bez minimalnych progów</span> - każda prowizja jest wypłacana
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 rounded-full bg-[#ffa920] flex items-center justify-center text-white font-bold text-xs flex-shrink-0 mt-1">
                ...
                <p className={`text-gray-700 ${ptSans.className}`}>
                  <span className="font-semibold">Transparentne rozliczenia</span> - śledzisz każdą transakcję
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="glass bg-gradient-to-br from-[#ffa920]/10 to-[#ec7308]/10 backdrop-blur-xl p-8 lg:p-10 rounded-3xl border border-[#ffa920]/20 shadow-large">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <p className={`text-gray-700 ${ptSans.className}`}>
                  <span className="font-semibold">Bonus za rejestrację</span> - 100 zł za pierwsze 10 zamówień
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 rounded-full bg-[#ffa920] flex items-center justify-center text-white font-bold text-xs flex-shrink-0 mt-1">
                ...
                <p className={`text-gray-700 ${ptSans.className}`}>
                  <span className="font-semibold">Nagrody miesięczne</span> - dodatkowe premie dla najlepszych
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 rounded-full bg-[#ffa920] flex items-center justify-center text-white font-bold text-xs flex-shrink-0 mt-1">
                ...
                <p className={`text-gray-700 ${ptSans.className}`}>
                  <span className="font-semibold">Promocje sezonowe</span> - zwiększone prowizje w okresach świątecznych
                </p>
              </div>
            </div>
          </div>
