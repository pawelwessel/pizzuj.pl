...
export default function AffiliateHowMuchDoYouWantToEarn() {
  ...
  // Calculate metrics
  const requiredReferrals = Math.ceil(monthlyGoal / (avgOrderValue * commissionRate));
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      setAnimatedCommission(Math.floor(monthlyGoal * commissionRate * easeOutQuart));
  ...
  return (
    <div className="relative py-16 lg:py-24 bg-gradient-to-br from-orange-50 to-yellow-50 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-gradient-to-tr from-orange-200/20 to-yellow-200/20 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
        
        {/* Moving pizza icons */}
        <div className="absolute top-20 left-10 w-8 h-8 text-orange-300 animate-bounce" style={{ animationDelay: '0.5s' }}>
          🍕
        </div>
        <div className="absolute top-40 right-20 w-8 h-8 text-orange-300 animate-bounce" style={{ animationDelay: '1.5s' }}>
          🍕
        </div>
        <div className="absolute bottom-20 left-20 w-8 h-8 text-orange-300 animate-bounce" style={{ animationDelay: '2s' }}>
          🍕
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto w-[90%] lg:w-4/5 xl:w-3/4 2xl:w-2/3">
        <div className="text-center mb-12">
          ...
          <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
            Ustaw swój cel finansowy, a pokażemy Ci, ile polecanych zamówień potrzebujesz
          </p>
        </div>
              ...
              <div className="mb-8">
                ...
                <div className="relative mb-6">
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #ffa920 0%, #ffa920 ${((monthlyGoal - 1000) / 19000) * 100}%, #f3f4f6 ${((monthlyGoal - 1000) / 19000) * 100}%, #f3f4f6 100%)`
                    }}
                  />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border-l-4 border-blue-400 transform transition-all duration-500 hover:scale-105">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-700 font-medium">Polecenia dziennie:</span>
              ...
              <div className="mt-4 bg-blue-50 p-3 rounded-xl">
                <p className="text-sm text-blue-700">
                  To tylko <strong>{dailyReferrals} polecenie{dailyReferrals > 1 ? (dailyReferrals < 5 ? 'a' : 'ń') : ''}</strong> dziennie!
                </p>
              </div>
            </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-orange-500 to-yellow-500 p-8 rounded-3xl text-white shadow-2xl">
            ...
            <p className="text-lg mb-6 opacity-90">
              Dołącz do naszego programu partnerskiego i zacznij zarabiać już dziś!
            </p>
