import { FaUserPlus, FaLink, FaShare, FaMoneyBillWave, FaArrowRight } from "react-icons/fa";
  ...
  const steps = [
    {
      ...
      icon: FaUserPlus,
      title: "Rejestracja",
      description: "Załóż darmowe konto partnerskie. Proces trwa tylko 2 minuty i nie wymaga żadnych opłat.",
      details: ["Wypełnij prosty formularz", "Potwierdź adres email", "Zaloguj się do panelu"],
    ...
    },
    {
      ...
      description: "Dostaniesz unikalne linki partnerskie do wszystkich pizzerii w naszej bazie.",
      details: ["Indywidualne linki do pizzerii", "Kody promocyjne", "Materiały marketingowe"],
    ...
    },
    {
      ...
      description: "Udostępniaj linki w social mediach, na blogu, stronie internetowej lub znajomym.",
      details: ["Social media", "Blog/strona www", "Email marketing", "Polecanie znajomym"],
    ...
    },
    {
      ...
      description: "Otrzymuj prowizję z każdego zamówienia złożonego przez osoby, które kliknęły Twój link.",
      details: ["Do 15% prowizji", "Wypłaty co 2 tygodnie", "Bez minimalnych progów"],
      color: "from-orange-500 to-orange-600"
    }
  ];

  return (
    <section id="jak-to-dziala" className="relative py-16 lg:py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-[95%] sm:w-[90%] lg:w-[80%] max-w-6xl">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className={`text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed ${ptSans.className}`}>
            Prosty proces w 4 krokach, który pozwoli Ci zacząć zarabiać w ciągu kilku minut.
          </p>
        </div>
              ...
              <div key={index} className="relative group">
                ...
                <div className="relative">
                  ...
                  <div className="glass bg-white/10 backdrop-blur-xl p-6 lg:p-8 rounded-2xl border border-white/20 hover:border-[#ffa920]/50 transition-all duration-300 group-hover:scale-105 card-hover">
                    ...
                    {/* Description */}
                    <p className={`text-gray-300 leading-relaxed mb-6 ${ptSans.className}`}>
                      {step.description}
                    </p>
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-20">
                      <FaArrowRight className="text-[#ffa920] text-xl animate-bounce-gentle" style={{ animationDelay: `${index * 0.5}s` }} />
                    </div>
                  )}
                </div>
