...
import { FaRocket, FaHandshake, FaArrowRight, FaUsers, FaMoneyBillWave, FaChartLine } from "react-icons/fa";
      ...
      <div className="relative z-10 mx-auto w-[95%] sm:w-[90%] lg:w-[80%] max-w-6xl">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <div className="glass bg-white/10 backdrop-blur-xl p-8 lg:p-12 xl:p-16 rounded-3xl border border-white/20 shadow-large">
            ...
            <p className={`text-lg lg:text-xl xl:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8 ${ptSans.className}`}>
              Dołącz do tysięcy zadowolonych partnerów, którzy już zarabiają z nami. 
              <span className="text-[#ffa920] font-semibold"> Twoja przygoda z zarabianiem online</span> zaczyna się już dziś!
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-6 lg:gap-8 mb-10 max-w-4xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-white text-sm lg:text-base">Rejestracja w 2 minuty</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#ffa920]/20 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#ffa920] text-xl font-bold">✓</span>
                </div>
                <p className="text-white text-sm lg:text-base">Pierwsze prowizje po tygodniu</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#ffa920]/20 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#ffa920] text-xl font-bold">✓</span>
                </div>
                <p className="text-white text-sm lg:text-base">Wsparcie 24/7</p>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-400 mb-8">
              ✓ Bez opłat rejestracyjnych  ✓ Bez ukrytych kosztów  ✓ Wypłaty gwarantowane
            </p>
          </div>
        </div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative z-10 p-6 lg:p-8">
                ...
                <p className={`text-gray-300 text-sm lg:text-base ${ptSans.className}`}>
                  {stat.label}
                </p>
              </div>
        ...
        {/* Final encouragement */}
        <div className="text-center">
          <p className={`text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed ${ptSans.className}`}>
            <span className="text-[#ffa920] font-semibold">Nie czekaj!</span> 
            {" "}Każdy dzień zwlekania to utracone możliwości zarobku. Dołącz do nas już dziś i zacznij budować swój pasywny dochód.
          </p>
        </div>
      </div>
    </section>
