  ...
  const faqs = [
    {
      ...
      answer: "Po rejestracji i zatwierdzeniu konta (do 24h) możesz natychmiast zacząć promować pizzerie. Pierwsze prowizje otrzymasz po pierwszych zamówieniach złożonych przez Twoje polecenia."
    },
    {
      question: "Czy są jakieś opłaty za udział w programie?",
      answer: "Nie, udział w programie partnerskim jest całkowicie darmowy. Nie ma opłat rejestracyjnych, miesięcznych ani żadnych ukrytych kosztów."
    },
    {
      question: "Jak są naliczane prowizje?",
      answer: "Prowizje są naliczane od wartości zamówienia (bez kosztów dostawy) i zależą od poziomu partnerskiego. Śledzenie jest w czasie rzeczywistym w Twoim panelu."
    },
    {
      question: "Kiedy otrzymam wypłatę prowizji?",
      answer: "Wypłaty realizujemy co 2 tygodnie na podane przez Ciebie konto bankowe. Nie ma minimalnych progów - wypłacamy każdą naliczoną prowizję."
    },
    {
      question: "Czy mogę promować wszystkie pizzerie?",
      answer: "Tak, jako partner masz dostęp do linków do wszystkich pizzerii w naszej bazie. Możesz wybierać te, które najlepiej pasują do Twojej grupy odbiorców."
    },
    {
      question: "Jak długo są ważne moje linki partnerskie?",
      answer: "Linki partnerskie są ważne przez 30 dni od kliknięcia. Jeśli użytkownik złoży zamówienie w tym okresie, otrzymasz prowizję."
    },
    {
      question: "Czy mogę polecać pizzerie znajomym i rodzinie?",
      answer: "Oczywiście! Polecanie znajomym i rodzinie to świetny sposób na start. Pamiętaj tylko, żeby zawsze używać swoich unikalnych linków partnerskich."
    },
    {
      question: "Jak mogę śledzić swoje wyniki?",
      answer: "W panelu partnerskim masz dostęp do szczegółowych statystyk: liczba kliknięć, konwersje, naliczone prowizje, historia wypłat i więcej."
    }
  ];
      ...
      <div className="relative z-10 mx-auto w-[95%] sm:w-[90%] lg:w-[80%] max-w-4xl">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className={`text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed ${ptSans.className}`}>
            Znajdź odpowiedzi na najczęściej zadawane pytania dotyczące programu partnerskiego.
          </p>
        </div>
        ...
        <div className="space-y-4 lg:space-y-6">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                  ...
                  <div className="px-6 lg:px-8 pb-6 lg:pb-8">
                    ...
                    <p className={`text-gray-700 leading-relaxed ${ptSans.className}`}>
                      {faq.answer}
                    </p>
                  </div>
                </div>
              ...
              {/* Hover indicator */}
              <div className={`absolute top-4 right-4 w-2 h-2 bg-[#ffa920] rounded-full transition-opacity duration-300 ${
        ...
        <div className="text-center mt-12 lg:mt-16">
          <div className="glass bg-gradient-to-r from-[#ffa920]/10 to-[#ec7308]/10 backdrop-blur-xl p-8 lg:p-10 rounded-3xl border border-[#ffa920]/20 shadow-large">
            ...
            <p className={`text-lg text-gray-600 mb-6 ${ptSans.className}`}>
              Nasz zespół wsparcia jest dostępny 24/7, aby odpowiedzieć na wszystkie Twoje pytania.
            </p>
