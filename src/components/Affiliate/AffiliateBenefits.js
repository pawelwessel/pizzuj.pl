  ...
  const benefits = [
    {
      ...
      description:
        "Zarabiaj do 15% z każdego zamówienia - jedna z najwyższych stawek na rynku",
    ...
    },
    {
      ...
      description:
        "Panel partnerski z dokładnymi statystykami i możliwością śledzenia każdego kliknięcia",
      color: "text-blue-500",
      bgColor: "bg-blue-50",
    },
    {
      ...
      title: "Wsparcie 24/7",
      description:
        "Dedykowany zespół wsparcia zawsze gotowy do pomocy i odpowiedzi na pytania",
    ...
    },
    {
      ...
      description:
        "Regularne wypłaty co 2 tygodnie, bez minimalnych progów ani ukrytych opłat",
    ...
    },
    {
      ...
      description:
        "Dodatkowe premie za najlepszych partnerów oraz specjalne promocje sezonowe",
      color: "text-pink-500",
      bgColor: "bg-pink-50",
    },
    {
      ...
      description:
        "Działamy od lat z tysiącami zadowolonych partnerów i stale rosnącą bazą klientów",
    ...
    <section className="relative py-16 lg:py-24 bg-gradient-to-br from-white to-gray-100 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-[95%] sm:w-[90%] lg:w-[80%] max-w-6xl">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          >
            Nasze korzyści sprawiają, że współpraca z nami to nie tylko
            zarabianie, ale budowanie długoterminowego partnerstwa.
          </p>
        </div>
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                {/* Description */}
                <p
                  className={`text-gray-600 leading-relaxed ${ptSans.className}`}
                >
                  {benefit.description}
                </p>
          ...
          <div className="glass bg-gradient-to-r from-[#ffa920]/10 to-[#ec7308]/10 backdrop-blur-xl p-8 lg:p-12 rounded-3xl border border-[#ffa920]/20 shadow-large">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <div className="text-sm text-gray-500">
                ✓ Rejestracja w 2 minuty ✓ Bez opłat ✓ Pierwsze prowizje już po
                tygodniu
              </div>
            </div>
          </div>
