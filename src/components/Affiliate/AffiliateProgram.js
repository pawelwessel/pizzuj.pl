...
export default function AffiliateProgram() {
  const stats = [
    { icon: FaPizzaSlice, number: "500+", label: "Pizzerii w bazie", color: "text-orange-500" },
    { icon: FaCity, number: "50+", label: "Miast w Polsce", color: "text-blue-500" },
    { icon: FaUsers, number: "1000+", label: "Aktywnych partnerów", color: "text-green-500" },
    { icon: FaPercent, number: "15%", label: "Maksymalna prowizja", color: "text-purple-500" },
  ];
      ...
      <div className="relative z-10 mx-auto w-[95%] sm:w-[90%] lg:w-[80%] max-w-6xl">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className={`text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed ${ptSans.className}`}>
            Jesteśmy największą platformą łączącą miłośników pizzy z najlepszymi pizzeriami w Polsce. 
            Nasz program partnerski to sprawdzona droga do stabilnych przychodów.
          </p>
        </div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <stat.icon className={`${stat.color} text-3xl lg:text-4xl mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`} />
                <h3 className="text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-800 mb-2">
                  {stat.number}
                </h3>
                <p className={`text-gray-600 text-sm lg:text-base font-medium ${ptSans.className}`}>
                  {stat.label}
                </p>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <p className={`text-gray-700 ${ptSans.className}`}>
                      <span className="font-semibold">Zarejestruj się</span> w naszym programie partnerskim - to zajmuje tylko 2 minuty
                    </p>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <p className={`text-gray-700 ${ptSans.className}`}>
                      <span className="font-semibold">Otrzymaj unikalne linki</span> do pizzerii i rozpocznij promocję
                    </p>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <p className={`text-gray-700 ${ptSans.className}`}>
                      <span className="font-semibold">Zarabiaj prowizję</span> z każdego zamówienia złożonego przez Twoich poleceń
                    </p>
                  </div>
                </div>
              </div>
