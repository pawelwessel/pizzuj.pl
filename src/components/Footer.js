          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="font-body text-gray-300 text-base lg:text-lg leading-relaxed max-w-md">
                Najlepsza platforma do znajdowania i oceniania pizzerii w Polsce. 
                Dołącz do społeczności miłośników pizzy!
              </p>
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="text-primary-400 group-hover:text-primary-300">📞</span>
                ...
                <a 
                  ...
                  className="group flex items-center gap-3 text-gray-300 hover:text-primary-300 transition-colors duration-200"
                >
                  <span className="text-primary-400 group-hover:text-primary-300">✉️</span>
          ...
          <div className="pt-8 border-t border-gray-700/50">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <span className="text-gray-300 group-hover:text-white text-lg">f</span>
                </Link>
              </div>
            </div>
          </div>
