  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-40 right-16 w-24 h-24 bg-gradient-to-br from-accent-200/30 to-accent-300/20 rounded-full blur-lg animate-bounce-gentle"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-32 left-1/4 w-40 h-40 bg-gradient-to-br from-primary-300/20 to-primary-400/15 rounded-full blur-2xl animate-bounce-gentle"
