...
export default function Loading() {
  return (
    <div className="fixed left-0 top-0 z-[99999999999999999999999] font-gotham font-light h-screen w-screen flex justify-center items-center bg-[#202020] text-xl text-white">
