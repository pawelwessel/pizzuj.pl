...
export default function HeroSectionForHomePage() {
  return (
    <div className="relative min-h-[35vh] w-full golden pt-20 pb-12 lg:pt-20 lg:pb-20">
      <Image
        src={accent}
        alt="Pizza"
      ...
      <div className="relative z-50 mx-auto w-[90%] lg:w-1/2">
        <div className="flex flex-col items-center justify-center bg-black/60 p-6 rounded-xl pt-12 pb-12">
