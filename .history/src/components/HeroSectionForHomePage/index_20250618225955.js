        ...
        <div className="glass bg-black/50 backdrop-blur-xl p-6 sm:p-8 lg:p-12 rounded-2xl lg:rounded-3xl border border-white/30 shadow-large">
          ...
          <div className="text-center mb-8 lg:mb-12">
            <h1 className="font-heading text-white text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight mb-4 lg:mb-6">
              ...
              <span className="bg-gradient-to-r from-primary-100 to-white bg-clip-text text-transparent">
                Twoim mieście
              </span>
            </h1>
            <p className="font-body text-white text-base sm:text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
              Wybierz najlepszą dla siebie restaurację i{" "}
              <Link
                href="/advertise"
                className="group inline-flex items-center"
              >
                <span className="text-white font-semibold underline decoration-primary-200 hover:decoration-white transition-colors duration-200 animate-pulse group-hover:animate-none">
                  zamów online
                </span>
              </Link>
            </p>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-3 lg:gap-4 w-full max-w-5xl mx-auto">
              {popularCities.map((city, index) => (
                ...
                >
                  <span className="font-heading text-black text-sm lg:text-base font-medium group-hover:text-green-600 transition-colors duration-200 block">
                    {city.name}
                  </span>
