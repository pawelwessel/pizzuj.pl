...
export default function PioneerBadge() {
  return (
    <div className="mx-auto text-center sm:text-left flex items-center gap-2 bg-gradient-to-r from-green-500 to-green-700 px-4 py-2 rounded-full">
      <div className="min-w-12 aspect-square bg-white rounded-full flex items-center justify-center p-2">
        <FaCrown className="text-[#ffa920] z-50 font-bold font-cocosharp-italic w-full" />
      </div>
      <FaCrown className="text-[#ffa920] z-50 font-bold font-cocosharp-italic" />
