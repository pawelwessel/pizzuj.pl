        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="order-2 lg:order-1">
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 lg:p-10 rounded-2xl shadow-lg border border-gray-100">
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-6 font-gothic">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 aspect-square bg-[#ffa920] rounded-full flex items-center justify-center">
                    <FaCode className="text-white text-xl" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800 font-gothic">
                      Programista
                    </h3>
