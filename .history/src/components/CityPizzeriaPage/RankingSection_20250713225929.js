              ...
              {pizzerias.slice(0, 6).map((pizzeria, index) => (
                ...
                >
                  ...
                  <div className="flex space-x-2">
                    <button className="font-cocosharp font-light uppercaseflex-1 bg-yellow-400 text-black py-2 px-4 rounded-lg hover:bg-yellow-300 transition-colors text-sm">
                      🍕 Zamów
                    </button>
