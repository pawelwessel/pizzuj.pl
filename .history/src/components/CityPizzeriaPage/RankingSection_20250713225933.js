              ...
              {pizzerias.slice(0, 6).map((pizzeria, index) => (
                ...
                >
                  ...
                  {(pizzeria.vicinity || pizzeria.address) && (
                    <p className="font-gotham !text-gray-600 text-sm mb-3">
                      📍 {pizzeria.vicinity || pizzeria.address}
                    </p>
                  )}
                  ...
                  {(pizzeria.opening_hours ||
                    ...
                    <p className="text-sm mb-3">
                      {(
                        ...
                        <span className="font-gotham text-green-600 font-semibold">
                          🟢 Otwarte
                        </span>
                      ) : (
                        <span className="font-gotham text-red-600 font-semibold">
                          🔴 Zamknięte
                        </span>
                      )}
                    </p>
                  ...
                  <div className="flex space-x-2">
                    <button className="w-full font-cocosharp font-light uppercase flex-1 bg-yellow-400 text-black py-2 px-4 rounded-lg hover:bg-yellow-300 transition-colors text-sm">
                      🍕 Zamów
                    </button>
                    <button className="w-full font-cocosharp font-light uppercase flex-1 bg-gray-100 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-200 transition-colors text-sm">
                      📞 Zadzwoń
                    </button>
                  </div>
                </motion.div>
