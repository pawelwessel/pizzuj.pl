      ...
      <div className="relative z-50 mx-auto w-[90%] lg:w-2/3 xl:w-1/2">
        ...
        >
          <motion.h1
            ...
            className="!text-white text-2xl lg:text-4xl xl:text-5xl drop-shadow-lg shadow-black font-bold mb-4 font-cocosharp"
          >
            {content.title}
          </motion.h1>
          ...
          <motion.p
            ...
            className={`mt-4 lg:mt-6 w-[90%] mx-auto !text-white drop-shadow-lg font-gotham text-base sm:text-lg lg:text-xl`}
          >
            {content.subtitle}
          </motion.p>
