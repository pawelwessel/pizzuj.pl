...
export default function RankingSection({ city, pizzerias }) {
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Sprawdź inne miasta lub dodaj swoją pizzerię do naszego
                rankingu!
              </p>
            </div>
          </motion.div>
            ...
            {pizzerias.length > 6 && (
              ...
              >
                <button className="bg-yellow-400 text-black font-bold py-3 px-8 rounded-full hover:bg-yellow-300 transition-colors shadow-lg">
                  Zobacz wszystkie pizzerie ({pizzerias.length})
                </button>
              </motion.div>
            )}
          </motion.div>
