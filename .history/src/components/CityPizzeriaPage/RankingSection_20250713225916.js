              ...
              {pizzerias.slice(0, 6).map((pizzeria, index) => (
                ...
                >
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button className="font-cocosharp font-light uppercase flex-1 bg-gray-100 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-200 transition-colors text-sm">
                      📞 Zadzwoń
                    </button>
                  </div>
                </motion.div>
