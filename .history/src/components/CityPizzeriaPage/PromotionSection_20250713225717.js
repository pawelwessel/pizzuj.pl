      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-xl !text-white max-w-3xl mx-auto font-cocosharp"
          >
            {content.subtitle}
          </motion.p>
        </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-bold text-black font-cocosharp">+150%</p>
                  <p className="text-sm text-black font-cocosharp">
                    Więcej klientów!
                  </p>
                </div>
              </div>
              ...
              {content.features.map((feature, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-gotham !text-white">
                      {feature.description}
                    </p>
                  </div>
                </motion.div>
