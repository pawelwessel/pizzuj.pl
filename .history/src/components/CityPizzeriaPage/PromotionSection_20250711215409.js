...
export default function PromotionSection({ city }) {
  return (
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            rankingu i zwiększ widoczność wśród lokalnych klientów!
          </motion.p>
        </motion.div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Więcej klientów</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Szczegółowe raporty sprzedaży i zachowań klientów",
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <h4 className="text-xl font-bold text-white mb-3">
                  🎁 Specjalna oferta dla {city}
                </h4>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center space-x-2">
                    <span className="text-green-400">✓</span>
                    <span>Darmowe dodanie do rankingu</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <span className="text-green-400">✓</span>
                    <span>Promocja przez 30 dni</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <span className="text-green-400">✓</span>
