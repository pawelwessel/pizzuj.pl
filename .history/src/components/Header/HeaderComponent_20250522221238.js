        ...
        <div className="flex w-full items-center justify-between">
          <div className="flex items-center">
            ...
            >
              <Image
                ...
                width={420}
                height={420}
                className="w-64 md:w-72 lg:w-80 p-3"
              />
            </Link>
          </div>
          <div className="lg:flex items-center justify-center w-full hidden">
            <div
              ...
              className={`w-max h-full py-9 group`}
            >
              <Link
                href="/praca-zdalna"
                onClick={() => {
                ...
                className={`flex text-black items-center w-max py-[10px] px-[10px] drop-shadow-sm duration-500 relative text-base cursor-pointer`}
              >
                <span
                  className={`relative z-50 ${
                    hovered === "cat" && "text-yellow-500 "
