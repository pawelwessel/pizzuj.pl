            ...
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-2xl border border-orange-100">
              <div className="mb-8">
                ...
                <div className="text-center py-6">
                  <div className="inline-flex items-center space-x-2 text-4xl lg:text-5xl font-bold golden bg-gradient-to-r from-orange-500 to-yellow-500 bg-clip-text text-transparent p-2">
