        ...
        <div className="glass bg-black/50 backdrop-blur-xl p-6 sm:p-8 lg:p-12 rounded-2xl lg:rounded-3xl border border-white/30 shadow-large">
          ...
          <div className="text-center mb-8 lg:mb-12">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-10">
              {highlights.map((highlight, index) => (
                ...
                >
                  ...
                  />
                  <span className="text-zinc-800 text-sm lg:text-base font-medium block">
                    {highlight.text}
                  </span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 lg:gap-6">
              ...
              <Link
                href="#jak-to-dziala"
                className="group inline-flex items-center gap-3 px-8 lg:px-12 py-4 lg:py-5 bg-white/20 hover:bg-white/30 !text-white font-heading font-semibold text-lg lg:text-xl rounded-full transition-all duration-300 ease-out transform hover:scale-105 backdrop-blur-sm border border-zinc-800/30 hover:border-zinc-800/50 text-zinc-800"
              >
