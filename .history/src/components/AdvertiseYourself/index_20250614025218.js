...
const PricingCard = ({
  ...
  <div
    className={`flex flex-col mt-12 items-center justify-center text-center w-full rounded-xl ${
      featured ? "border-2 border-[#ffa920]" : "border border-gray-200"
    } shadow-lg hover:shadow-xl hover:border-[#ffa920] transition-all duration-300 group relative ${
