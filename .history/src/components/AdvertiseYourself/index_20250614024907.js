  ...
  return (
    <div className="relative px-6 lg:px-12 pb-12 flex flex-col items-center">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 lg:gap-12 mt-6">
        <div className="flex flex-col mt-12 items-center justify-center text-center w-full h-full rounded-xl border border-gray-200 shadow-lg hover:shadow-xl hover:border-[#ffa920] transition-all duration-300 group relative">
        ...
        <div className="flex flex-col mt-12 items-center justify-center text-center w-full h-full rounded-xl border-2 border-[#ffa920] shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
          <div className="w-full h-48 lg:h-64 overflow-hidden">
            <Image
              src={i2}
              alt="Za darmo"
          ...
          <div className="relative flex flex-col flex-1 justify-between p-6">
            <div>
              <div className="text-2xl font-light text-black font-cocosharps italic">
                od 199zł/msc
              </div>
              <h2 className="text-3xl font-bold text-black mt-12 group-hover:text-[#ffa920] transition-colors duration-300">
                Pakiety premium
        ...
        <div className="flex flex-col mt-12 items-center justify-center text-center w-full h-[80vg] rounded-xl border border-gray-200 shadow-lg hover:shadow-xl hover:border-[#ffa920] transition-all duration-300 group relative">
          <div className="w-full h-48 lg:h-64 overflow-hidden absolute left-0 top-0">
            <Image
              src={i3}
              alt="Za darmo"
              width={1024}
