...
const FeatureItem = ({ title }) => (
  <div className="flex w-full items-center lg:justify-center lg:flex-col gap-3 p-6 rounded-xl hover:bg-gray-50 transition-all duration-300 group">
    <FaCheckCircle className="text-[#ffa920] w-12 h-12 lg:w-16 lg:h-16 group-hover:scale-110 transition-transform duration-300" />
    <p className="font-cocosharp font-medium text-left text-black w-[80%] lg:text-center text-lg">
      {title}
    </p>
  </div>
);
...
export default function AdvertiseYourself() {
  return (
    <section className="relative py-16 lg:py-24 bg-gradient-to-br from-gray-50/50 via-white/75 to-gray-100/50 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-[95%] sm:w-[90%] lg:w-[80%] max-w-7xl">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <h1 className="font-cocosharp-bold text-4xl lg:text-5xl xl:text-6xl text-gray-800 leading-tight mb-6">
          ...
          <div className="glass bg-white/80 backdrop-blur-xl p-8 lg:p-10 rounded-3xl border border-[#ffa920]/20 shadow-large max-w-4xl mx-auto group hover:border-[#ffa920]/40 transition-all duration-300">
            <p
              className={`text-lg lg:text-xl text-gray-700 leading-relaxed font-gotham`}
            >
        ...
        <div className="relative">
          <div className="flex items-center justify-center gap-6 mb-12">
            ...
            <h3 className="font-cocosharp-bold text-xl md:text-3xl lg:text-4xl text-gray-800 text-center">
              Nasza oferta
            </h3>
