...
export default function AdvertiseYourself() {
  return (
    <div className="relative px-6 lg:px-12 pb-12 flex flex-col items-center">
      ...
      <p
        className={`w-full lg:max-w-[70%] font-sans text-left mt-12 text-black border-l-2 border-[#ffa920] p-4 bg-gray-200 ${ptSans.className} font-cocosharp-italic font-bold`}
      >
