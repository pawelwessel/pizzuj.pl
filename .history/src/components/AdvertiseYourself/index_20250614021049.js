  ...
  return (
    <div className="relative px-6 lg:px-12 pb-12 flex flex-col items-center">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 lg:gap-12 mt-6">
        <div className="flex flex-col mt-12 items-center justify-center text-center w-full p-6 rounded-xl hover:bg-gray-50 transition-all duration-300 group">
          ...
          <p className="w-full lg:max-w-[70%] font-sans text-left mt-12 text-black border-l-2 border-[#ffa920] p-4 bg-gray-200 shadow-md hover:shadow-lg transition-shadow duration-300">
            Dołącz i stwórz profil swojej pizzerii.
          </p>
        </div>
        <div className="flex flex-col mt-12 items-center justify-center text-center w-full p-6 rounded-xl hover:bg-gray-50 transition-all duration-300 group relative">
          <div className="absolute -top-4 right-4 bg-[#ffa920] text-white px-3 py-1 rounded-full text-sm">
            Polecane
          </div>
          <div className="relative">
            <h2 className="text-3xl font-bold text-black mt-12 group-hover:text-[#ffa920] transition-colors duration-300">
