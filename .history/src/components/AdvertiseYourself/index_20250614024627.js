  ...
  return (
    <div className="relative px-6 lg:px-12 pb-12 flex flex-col items-center">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 lg:gap-12 mt-6">
        <div className="flex flex-col mt-12 items-center justify-center text-center w-full rounded-xl border border-gray-200 shadow-lg hover:shadow-xl hover:border-[#ffa920] transition-all duration-300 group">
        ...
        <div className="flex flex-col mt-12 items-center justify-center text-center w-full rounded-xl border-2 border-[#ffa920] shadow-lg hover:shadow-xl transition-all duration-300 group relative">
          <div className="max-h-[50vh] overflow-hidden absolute left-0 top-0">
            <Image
              src={i2}
              alt="Za darmo"
