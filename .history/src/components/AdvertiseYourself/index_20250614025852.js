...
const PricingCard = ({
  ...
  >
    ...
    <div className="relative flex flex-col flex-1 p-6 items-center justify-center">
      <div>
      ...
      <p className="text-center w-full lg:max-w-[70%] font-sans text-left mt-12 text-black border-l-2 border-[#ffa920] p-4 bg-gray-100 rounded-xl shadow-inner">
        {description}
      </p>
    </div>
  </div>
