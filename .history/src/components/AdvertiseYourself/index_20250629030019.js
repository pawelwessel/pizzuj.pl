...
const PricingCard = ({
  ...
  >
    ...
    <div className="relative flex flex-col flex-1 items-center justify-center w-full h-full">
      <div className="flex flex-col items-center justify-center bg-black/50 p-3 sm:p-4 w-full">
        <div className="!text-sm 2xl:text-2xl font-light !text-white font-cocosharp italic">
          {price}
        </div>
        <h2
          className={`my-2 !text-lg w-max sm:text-3xl font-bold text-[#ffa920] transition-colors duration-300 ${ptSans.className}`}
        >
          {title}
        </h2>
