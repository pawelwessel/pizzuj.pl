      ...
      <div className="glass rounded-3xl p-12 md:p-16 text-gray-800 max-w-5xl mx-auto border-2 border-white/30 shadow-golden-xl relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button className="font-gotham text-center bg-gradient-to-r from-[#ffa920] to-[#ff8c00] text-white font-bold px-12 py-5 rounded-2xl transition-all duration-300 shadow-golden hover:shadow-golden-xl transform hover:scale-105 relative overflow-hidden group/btn">
              {/* Button shine effect */}
            ...
            <button className="font-gotham text-center border-2 border-primary-500 hover:border-primary-600 text-primary-700 hover:text-primary-800 font-bold px-12 py-5 rounded-2xl hover:bg-primary-50 transition-all duration-300 transform hover:scale-105 relative overflow-hidden group/btn2">
              {/* Button shine effect */}
