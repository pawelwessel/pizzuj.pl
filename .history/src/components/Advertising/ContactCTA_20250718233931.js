        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
            <div className="flex items-center gap-3 text-green-600 font-semibold">
              ...
              <span className="text-xs">Darmowa konsultacja</span>
            </div>
            <div className="flex items-center gap-3 text-blue-600 font-semibold">
              ...
              ></div>
              <span className="text-xs">Spersonalizowane rozwiązania</span>
            </div>
            <div className="flex items-center gap-3 text-purple-600 font-semibold">
              ...
              ></div>
              <span className="text-xs">Wsparcie techniczne</span>
            </div>
          </div>
