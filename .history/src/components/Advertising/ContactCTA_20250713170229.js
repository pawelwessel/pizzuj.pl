        ...
        <div className="relative z-10">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-500 text-white px-6 py-3 rounded-full text-sm font-semibold mb-6 shadow-lg">
              ...
              <span>Potrzebujesz pomocy w wyborze?</span>
            </div>
          </div>
          ...
          <p className={`text-xl lg:text-2xl mb-12 text-gray-700 leading-relaxed max-w-3xl mx-auto ${ptSans.className}`}>
            Skontaktuj się z nami, a pomożemy Ci wybrać najlepsze rozwiązanie
            dla Twojej pizzerii. Nasi eksperci są dostępni 24/7!
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
            ...
            <div className="flex items-center gap-3 text-blue-600 font-semibold">
              ...
              <span>Spersonalizowane rozwiązania</span>
            </div>
          ...
          <div className="mt-8 text-sm text-gray-500">
            <p className={`${ptSans.className}`}>Lub skontaktuj się bezpośrednio:</p>
