      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="glass rounded-3xl p-10 md:p-16 border-2 border-white/40 shadow-golden-xl backdrop-blur-sm relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <h1 className="font-cocosharp !text-2xl md:!text-4xl xl:!text-5xl 2xl:!text-6xl font-bold text-zinc-800 mb-8">
              Wypromuj swoją
              <span className="!text-[#ffa920] block mt-3">
                pizzerię z Pizzuj.pl!
              </span>
            </h1>

            <p
              className={`text-xl md:text-2xl text-gray-700 max-w-2xl mx-auto leading-relaxed mb-8 font-gotham`}
            >
