  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center text-center pt-16 pb-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-64 h-64 lg:w-96 lg:h-96 opacity-20">
          <Image
            src="/newAssets/1.jpg"
        ...
        <div className="absolute bottom-0 left-0 w-48 h-48 lg:w-64 lg:h-64 opacity-20">
          <Image
            src="/newAssets/2.jpg"
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 lg:w-48 lg:h-48 opacity-30">
          <Image
            src="/newAssets/3.jpg"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="glass rounded-3xl p-10 md:p-16 border-2 border-white/40 shadow-golden-xl backdrop-blur-sm relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p
              className={`text-xl md:text-2xl lg:text-3xl text-gray-700 max-w-4xl mx-auto leading-relaxed mb-8 ${ptSans.className}`}
            >
              Wybierz pakiet dla Twojego biznesu i zacznij przyciągać więcej
              klientów już dziś
            </p>
