    ...
    <>
      ...
      >
        ...
        <input
          ...
          type="text"
          name="search"
          className="py-5 px-12 rounded-xl bg-white/50 text-black w-[550px] max-w-[80%] mx-auto block"
          placeholder="Wpisz miasto"
        />
        <button
          onClick={async () => await handleSearch()}
          className="text-white text-sm goldenShadow py-8 rounded-b-lg flex w-max mx-auto max-w-full items-center px-8"
        >
