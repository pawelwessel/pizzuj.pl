    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-center">
          <div className="absolute left-0 rounded-l-full goldenShadow top-0 h-full aspect-square flex items-center justify-center">
          ...
          <input
            ...
            type="text"
            name="search"
            className="py-4 px-8 !pl-12 rounded-xl rounded-l-full bg-white/50 text-black w-[550px] max-w-[80%] mx-auto block"
