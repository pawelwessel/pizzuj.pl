...
export default function Form() {
  ...
  return (
    ...
    >
      <div className="z-50 rounded-xl py-12 w-full h-[120%] -mt-3 fixed left-0 top-0 bg-black/50 text-white text-lg items-center justify-center text-center flex flex-col">
        {loadingText}
        <br />
        <div className="block">
          {loadingTimer}
