      ...
      >
        ...
        <div className="max-w-full relative flex items-center">
          <input
            ...
            type="text"
            name="search"
            className="border-2 border-zinc-800rounded-l-xl font-sans placeholder:text-black/50 text-lg py-4 h-12 pl-4 bg-white/50 text-black w-[200px] lg:w-full mx-auto"
