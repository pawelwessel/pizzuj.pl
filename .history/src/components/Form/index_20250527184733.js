...
export default function Form() {
  ...
  return (
    ...
    >
      <div className="rounded-xl lg:max-w-[500px] w-[90%] sm:w-[80%] py-12 h-[120%] -mt-3 absolute left-0 top-0 bg-black/50 text-white text-lg items-center justify-center text-center flex flex-col">
        {loadingText}
        <br />
        <div className="block">
          {loadingTimer}
