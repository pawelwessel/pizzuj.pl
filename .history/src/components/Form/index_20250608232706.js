    ...
    <>
      ...
      >
        ...
        <div className="max-w-full relative flex items-center">
          <div className="h-12 sm:h-16 rounded-l-xl bg-white/50 top-0 aspect-square flex items-center justify-center">
            <FaLocationPin className="w-6 h-6 text-black/35" />
          </div>
          <input
            ...
            type="text"
            name="search"
            className="font-sans placeholder:text-black/50 text-lg py-4 h-12 sm:h-16 pl-6 bg-white/50 text-black w-[150px] lg:w-[200px] mx-auto"
          ...
          <button
            ...
            className="text-white text-sm h-12 sm:h-16 goldenShadow py-4 rounded-r-lg flex w-max mx-auto max-w-full items-center px-3"
          >
