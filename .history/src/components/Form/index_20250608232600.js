      ...
      >
        ...
        <div className="max-w-full relative flex items-center">
          ...
          <input
            ...
            type="text"
            name="search"
            className="font-sans placeholder:text-black/50 text-lg py-4 h-16 pl-6 bg-white/50 text-black w-[150px] lg:w-[200px] mx-auto"
          ...
          <button
            ...
            className="text-white text-sm h-16 goldenShadow py-4 rounded-r-lg flex w-max mx-auto max-w-full items-center px-8"
          >
