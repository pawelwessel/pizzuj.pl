    ...
    <div className="relative">
      ...
      <div className="max-w-full relative flex items-center">
        ...
        <input
          ...
          type="text"
          name="search"
          className="border border-gray-400 border-r-0 rounded-l-xl font-sans placeholder:text-black/50 text-lg py-4 h-12 pl-4 bg-white/50 text-black w-full mx-auto"
