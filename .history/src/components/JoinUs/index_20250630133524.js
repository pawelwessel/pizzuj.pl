...
export default function JoinUs() {
  return (
    <div>
      <div className="flex flex-col items-center justify-center gap-6 text-black px-8 pb-16 pt-12 mx-4 mt-16 relative">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <div className="text-center relative">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 leading-tight">
              Dołącz teraz i{" "}
              <span className="!text-[#ffa920]">zdobądź odznakę</span>
            </h2>
          ...
          <div className="group relative">
            <Link
              href="/login"
              className="relative px-8 py-4 bg-[#ffa920] hover:bg-[#ff8f00] !text-white font-semibold rounded-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl flex items-center gap-3 shadow-lg"
            >
      ...
      <div className="mx-auto text-center sm:text-left flex items-center gap-2 bg-gradient-to-r from-green-500 to-green-700 px-4 py-2 rounded-full">
        ...
        <span className="text-sm sm:text-base text-zinc-800 z-50 font-cocosharp-italic">
