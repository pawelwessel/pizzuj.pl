...
export default function PioneerBadge() {
  return (
    <div className="mx-auto text-center sm:text-left flex items-center gap-2 bg-gradient-to-r from-green-500 to-green-700 !text-green-700 px-4 py-2 rounded-full shadow-lg">
