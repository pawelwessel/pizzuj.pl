        ...
        {placesData?.map((place, index) => {
          ...
          return (
            <li
              ...
              } cursor-pointer rounded-2xl relative w-full p-1 group hover:border-yellow-500 border-transparent border-2 duration-300`}
            >
                ...
                <div className="w-full lg:min-w-60">
                  ...
                  >
                    <Image
                      ...
                      width={400}
                      height={400}
                      className="group-hover:scale-[1.01] duration-100 rounded-xl w-full h-60 sm:h-[400px] xl:h-60 object-cover"
                    />
                  </Link>
                </div>
