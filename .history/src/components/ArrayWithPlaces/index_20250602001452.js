            ...
            <div className="flex flex-col lg:flex-row  w-full">
              <div className="w-full lg:min-w-60">
                <Image
                  ...
                  width={400}
                  height={400}
                  className="border-[#ffa920] border-b-[6px] lg:border-b-0 lg:border-r-[6px] rounded-t-lg lg:rounded-t-none lg:rounded-l-lg w-full h-60 sm:h-[400px] lg:h-60 object-cover"
                />
              </div>
