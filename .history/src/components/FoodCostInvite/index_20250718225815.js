  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-10 left-10 w-16 h-16 bg-primary-300/20 rounded-full animate-bounce-gentle"
          style={{ animationDelay: "0s" }}
        ></div>
        <div
          className="absolute top-20 right-20 w-12 h-12 bg-primary-400/30 rounded-full animate-bounce-gentle"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/4 w-20 h-20 bg-primary-200/15 rounded-full animate-bounce-gentle"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-10 right-1/3 w-8 h-8 bg-primary-500/25 rounded-full animate-bounce-gentle"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center gap-3 p-3 bg-white/60 rounded-xl border border-primary-200/30 backdrop-blur-sm transform hover:scale-105 transition-all duration-300"
                  >
            ...
            <div className="relative">
              <div className="relative bg-gradient-to-br from-primary-100 to-primary-200 rounded-3xl shadow-medium">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="border-t pt-3 mt-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-cocosharp-bold-italic text-xl text-primary-600">
                            9.00 zł
                          </span>
                        </div>
                ...
                {/* Decorative elements */}
                <div
                  className="absolute -top-4 -right-4 w-8 h-8 bg-primary-400 rounded-full animate-bounce-gentle"
                  style={{ animationDelay: "0.5s" }}
                ></div>
                <div
                  className="absolute -bottom-2 -left-2 w-6 h-6 bg-primary-300 rounded-full animate-bounce-gentle"
                  style={{ animationDelay: "1.5s" }}
                ></div>
              </div>
            </div>
