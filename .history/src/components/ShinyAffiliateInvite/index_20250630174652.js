...
export const ShinyAffiliateInvite = () => {
  return (
    <div className="mt-24 relative overflow-hidden bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 rounded-2xl p-6 md:p-8 shadow-2xl transform hover:scale-105 transition-all duration-300 group">
      ...
      <div className="relative z-10 text-center">
        ...
        <p className="font-body text-white/90 text-sm md:text-base mb-6 max-w-md mx-auto leading-relaxed">
          Zarabiaj do <span className="font-bold text-white">30%</span> prowizji
          promując najlepsze pizzerie w Polsce
        </p>
