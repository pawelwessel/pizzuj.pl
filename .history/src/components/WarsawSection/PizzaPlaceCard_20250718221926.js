...
export default function PizzaPlaceCard({ place, onCardClick }) {
  ...
  return (
    <div className={`${!place.photos[0] ? "hidden" : ""} px-3 lg:px-4`}>
      ...
      >
        <div className=" bg-white rounded-2xl lg:rounded-3xl overflow-hidden shadow-large hover:shadow-golden-lg border border-white/20 transition-all duration-300">
          {/* Image container */}
