...
export default function Login() {
  ...
  return (
    <div className="px-6 font-sans min-h-screen w-full bg-slug bg-cover bg-center mx-auto relative flex flex-col-reverse md:flex-row items-center justify-center">
      <Image
        src={loginImage}
        className="w-full md:w-[33vw] lg:w-[50vw] h-full object-cover rounded-xl"
        alt="Login"
        width={1000}
        height={1000}
        priority
