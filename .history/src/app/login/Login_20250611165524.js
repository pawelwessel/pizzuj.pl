...
export default function Login() {
  ...
  return (
    <div className="font-sans min-h-screen w-full bg-slug bg-cover bg-center mx-auto relative flex flex-col-reverse md:flex-row items-center justify-center">
      ...
      >
        <div className="absolute top-0 left-0 text-nowrap flex-wrap w-full h-full bg-black/50 text-center text-white font-bold px-12 flex items-center justify-center">
