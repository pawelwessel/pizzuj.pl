...
export default function Login() {
  ...
  return (
    <div className="font-sans min-h-screen w-full bg-slug bg-cover bg-center mx-auto relative flex flex-col-reverse md:flex-row items-center justify-center">
      ...
      >
        <div className="absolute top-0 left-0 text-nowrap flex-wrap w-full h-full bg-black/90 text-center text-white font-bold flex items-center justify-center">
          <p className="text-4xl font-bold animate-pulse scale-125">
