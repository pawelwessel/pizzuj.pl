...
export default function Login() {
  ...
  return (
    <div className="font-sans min-h-screen w-full bg-slug bg-cover bg-center mx-auto relative flex flex-col-reverse md:flex-row items-center justify-center">
      ...
      >
        <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50 text-center text-white font-bold px-12 flex items-center justify-center">
          <h2 className="text-4xl font-bold">Dołącz do pizuj już dziś!</h2>
        </div>
      </div>
