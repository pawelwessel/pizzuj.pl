  ...
  return (
    <div className="font-sans min-h-screen w-full bg-slug bg-cover bg-center mx-auto relative flex flex-col-reverse md:flex-row items-center justify-center">
      <div
        ...
        className="relative w-full md:w-[33vw] lg:w-[50vw] xl:w-[50vw] h-screen bg-cover bg-center loginImage"
      >
        <div className="absolute top-0 left-0 text-nowrap flex-wrap w-full h-full bg-black/90 z-10"></div>
        <div className="text-nowrap flex-wrap w-full h-full text-white font-bold flex items-center justify-center text-center">
          <p className="text-4xl font-bold animate-pulse z-0">
            Dołącz do pizuj już dziś!
          </p>
          <p className="text-4xl font-bold animate-pulse z-0">
            Dołącz do pizuj już dziś!
          </p>
