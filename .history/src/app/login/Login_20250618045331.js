    ...
    <div className="py-12 px-6 font-sans min-h-screen w-full bg-slug bg-cover bg-center mx-auto relative flex flex-col-reverse md:flex-row items-center justify-center">
      ...
      <div className="w-full mx-auto md:w-[67vw] lg:w-[50vw] sm:px-2 sm:p-4 lg:p-6 h-full flex items-center justify-center">
        <div className="w-full p-6 2xl:px-12 bg-gradient-to-b from-[#ffa920] via-white to-white rounded-br-xl rounded-tl-xl md:mx-6 2xl:mx-12">
          <h2
            className={`justify-center text-zinc-700 text-shadow shadow-xl py-3 pr-3 font-bold text-2xl lg:text-3xl drop-shadow-xl shadow-black mb-6 flex flex-row items-center`}
          >
