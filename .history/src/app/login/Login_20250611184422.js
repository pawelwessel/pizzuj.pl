          ...
          <div className="mt-6 grid grid-cols-1 gap-3 w-full">
            <div className="flex flex-col md:flex-row items-center gap-3">
              <button
                disabled={isThinking}
                onClick={signIn}
                className="md:w-max w-full max-w-full px-6 py-3.5 rounded-br-xl rounded-tl-xl disabled:bg-gray-600 goldenShadow hover:bg-opacity-80 duration-150 text-white font-bold"
              >
                {!isThinking && (
