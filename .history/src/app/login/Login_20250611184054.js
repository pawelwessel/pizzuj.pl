        ...
        <div className="w-full p-6 2xl:px-12 bg-white md:mx-6 2xl:mx-12">
          ...
          <div className="grid grid-cols-1 gap-3 w-full">
            <button
              disabled={isThinking}
              onClick={signIn}
              className="mt-2 w-max max-w-full py-3.5 rounded-br-xl rounded-tl-xl disabled:bg-gray-600 goldenShadow hover:bg-opacity-80 duration-150 text-white font-bold"
            >
              {!isThinking && (
