...
export default function Page() {
  return (
    <div className="golden grid grid-cols-1 lg:grid-cols-3 px-6 sm:px-12 lg:px-24 gap-6 xl:gap-12">
      <div className="bg-white flex flex-col px-6 py-6 mt-[45vh]">
      ...
      <div className="bg-white flex flex-col px-6 py-6 mt-12">
        <h2 className="text-xl lg:text-3xl text-black text-center">Za darmo</h2>
        <ul>
          <li className="flex mt-12">
            <div className="min-w-9 h-auto aspect-square">
