...
export default function Page() {
  return (
    <div className="golden px-6 sm:px-12 lg:px-24">
      <div className="text-whit eh-[40vh] items-center flex justify-center text-center">
        <h1>Hej, a może... Pizzuj.pl!</h1>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 xl:gap-12 pt-[40vh] golden">
