  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-6 bg-[#ffa920] p-6 relative">
        <div className="w-max p-4 rounded-xl absolute top-0 -translate-y-[10%] left-1/2 -translate-x-1/2 bg-gray-300 text-black text-white z-0">
          {page?.page?.businessName}
        </div>
        <div className="p-6 pt-12 text-center bg-white rounded-md shadow-lg">
