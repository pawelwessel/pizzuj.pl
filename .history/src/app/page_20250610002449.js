    ...
    <div>
      ...
      <div className="relative w-full py-12">
        <Image
          ...
          height={250}
        />
        <h2 className="border-x border-yellow-500 text-2xl font-bold pt-12 pb-6 text-center">
          Dołącz do pizzuj
        </h2>
        <p className="border-x border-yellow-500 text-center text-sm lg:text-base font-sans">
          Dołącz do naszej sieci i zyskaj nowych klientów. Wspólnie <br />{" "}
          zbudujemy najlepszą sieć pizz w Polsce.
        </p>
        <p className="border-x border-yellow-500 text-center text-sm lg:text-base font-sans font-light text-gray-700 mb-12 mt-4">
