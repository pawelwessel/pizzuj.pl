  ...
  return (
    <>
      {(pizzeriaData === null || pizzeriaData === undefined) && (
        <div className="bg-black text-white fixed left-1/2 -translate-y-1/2 top-0 w-full h-max text-center justify-center items-center flex">
        ...
        <div className="relative px-6 lg:px-12 pb-12 flex flex-col items-center justify-center">
          ...
          <div className="relative mt-12 mb-6">
            <Image
              src={accent2}
              alt="Promuj swój lokal z pizzą"
              className="w-20 lg:w-32 xl:w-36 2xl:w-40 lg:-top-8 xl:top-0 h-auto absolute z-0 right-3 lg:-right-60 xl:-right-96 top-16 opacity-20"
              width={250}
              height={250}
            />
