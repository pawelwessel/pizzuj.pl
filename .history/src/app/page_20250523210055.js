  ...
  return (
    <div>
      ...
      <div className="px-6 lg:px-12 pb-12 flex flex-col items-center justify-center">
        ...
        <p className="font-light max-w-[90%] lg:max-w-[66%] mx-auto text-center mt-4 text-black">
      ...
      <Image src={pizza} alt="Promuj swój lokal z pizzą" className="w-full h-auto" />
      <div className="px-6 lg:px-12 pb-12 flex flex-col items-center justify-center">
        <h2 className="text-3xl font-bold text-black mt-3 text-center sm:w-[65%] mx-auto w-[80%]">
          Zachęcamy do rozpoczęcia promowania swojej pizzerii
        </h2>
      <CtaButton />
      <Footer />
    </div>
