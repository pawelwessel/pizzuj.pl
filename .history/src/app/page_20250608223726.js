...
export default function Page() {
  return (
    <div>
      <div className="relative min-h-[35vh] w-full golden pt-24 pb-12">
        <Image
          src={accent}
          alt="Pizza"
        ...
        <div className="relative z-50 mx-auto w-[90%] lg:w-1/2">
          <div className="flex flex-col items-center justify-center bg-black/60 p-6 rounded-xl pt-12 pb-6">
            ...
            <h2 className="text-white font-sans mt-8 text-center max-w-[80%] lg:max-w-[66%]">
              Często wyszukiwane
            </h2>
            <div className="relative flex lg:justify-center items-center gap-4 lg:gap-12 !text-sm z-50 flex-wrap mt-6 px-6">
              <Link
                href="pizza/warszawa"
