...
import Opinions from "../../components/UserDashboard/Opinions/index";
import Marketing from "../../components/UserDashboard/Marketing/index";
import Settings from "../../components/UserDashboard/Settings/index";
...
export default function UserProfile() {
  ...
  // Onboarding system - always call with consistent value
  const {
    onboardingState,
    ...
    startOnboarding,
    startFeatureTour,
  } = useOnboarding(user ? user.uid : null);
