            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="glass bg-white/60 border border-primary-200/30 rounded-2xl lg:rounded-3xl p-6 lg:p-8 backdrop-blur-sm shadow-medium">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
                  <div className="flex items-center gap-3 p-4 bg-gray-400/50 rounded-xl border border-primary-100">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-400/50 bg-white/50 rounded-xl border border-primary-100">
                    <div className="w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-[#ffa920] text-2xl font-bold">
                        ✓
                      </span>
