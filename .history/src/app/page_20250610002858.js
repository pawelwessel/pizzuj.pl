  ...
  return (
    <div>
      ...
      <div className="relative w-full pb-12">
        ...
        <p className="border-x text-gray-500 border-yellow-500 px-3 block w-max max-w-full mx-auto text-center text-xs lg:text-base font-sans font-light mb-12 mt-12">
