    ...
    <div>
      ...
      <div className="relative w-full pb-12">
        <Image
          ...
          height={250}
        />
        <h2 className="rounded-b-xl golden text-white border-x border-yellow-500 mb-12 block w-max max-w-full mx-auto text-2xl font-bold pt-6 pb-6 px-12 text-center">
          Dołącz do pizzuj
        </h2>
        <p className=" py-3border-x border-yellow-500 px-3 block w-max max-w-full mx-auto text-center text-sm lg:text-base font-sans">
          Dołącz do naszej sieci i zyskaj nowych klientów. Wspólnie <br />{" "}
          zbudujemy najlepszą sieć pizz w Polsce.
        </p>
        <p className="border-x border-yellow-500 px-3 block w-max max-w-full mx-auto text-center text-sm lg:text-base font-sans font-light text-gray-700 mb-12 mt-4">
