    ...
    <div>
      <div className="relative min-h-[35vh] w-full golden pt-24">
        ...
        <Image
          src={accent1}
          alt="Pizza"
          className="absolute h-24 lg:h-[80%] w-auto opacity-20 lg:opacity-15 right-6 lg:right-16 xl:right-36 bottom-6 lg:bottom-auto lg:top-1/2 lg:-translate-y-1/2 z-0"
          width={300}
          height={300}
        />
