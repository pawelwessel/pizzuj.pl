  ...
  return (
    <div>
      ...
      <div className="px-6 lg:px-12 pb-12 flex flex-col items-center justify-center">
        ...
        <p className="max-w-[90%] lg:max-w-[66%] mx-auto text-center mt-4 text-gray-600">
          Dzięki współpracy z nami zwiększysz obecność swojej restauracji w
          internecie. Wyróżnimy Twoją pizzerię w Pizzuj.pl oraz w wyszukiwarce
          Google. Podwoisz ruch w swoim lokalu, zyskasz nowe opinie oraz stałych
          klientów.
        </p>
      </div>
      <Footer />
