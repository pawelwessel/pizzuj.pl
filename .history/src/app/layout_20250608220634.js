  ...
  return (
    <html lang="en">
      <body className={`${gothic.variable} antialiased`}>
        <div className="fixed left-0 top-0 w-screen h-screen bg-black/70 text-white font-bold text-4xl lg:text-5xl flex items-center text-center justify-center z-[500]">
