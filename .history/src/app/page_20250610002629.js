    ...
    <div>
      ...
      <div className="relative w-full pb-12">
        <Image
          ...
          height={250}
        />
        <h2 className="rounded-b-xl golden text-white border-x border-yellow-500 px-3 block w-max max-w-full mx-auto text-2xl font-bold pt-6 pb-6 px-12 text-center">
          Dołącz do pizzuj
        </h2>
