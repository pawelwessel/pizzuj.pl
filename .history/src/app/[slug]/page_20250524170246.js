...
export async function generateStaticParams() {
  return pages.map((page) => ({
    slug: removePolishSignsAndSpaces(page.address),
  }));
}

export default async function Page({ params }) {
  const page = pages.find(
    (p) => removePolishSignsAndSpaces(p.address) === params.slug
  );
  ...
  return (
    <div>
      <div className="overflow-hidden relative min-h-[35vh] w-full golden pt-24 pb-12">
        ...
        <div className="relative z-50 mx-auto w-[90%] lg:w-1/2">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-6 w-[90%] mx-auto lg:w-[66%] text-white drop-shadow-lg">
              {page.introduction}
            </p>
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 bg-[#ffa920] p-6">
...
//   );
//   const { googleTitle, googleDescription, businessName } = page;
