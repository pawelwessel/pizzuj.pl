  ...
  return (
    <div>
      ...
      <div className="relative w-full pb-12">
        ...
        <p className="border-x border-yellow-500 px-3 block w-max max-w-full mx-auto text-center text-xs lg:text-base font-sans font-light text-gray-700 mb-12 mt-24">
